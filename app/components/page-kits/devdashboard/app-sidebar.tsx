...
import { devNavItems, useDevSidebarNav } from "./sidebar-nav-context"
import { devNavIcons } from "./nav-icons"
              ...
              <SidebarGroupContent className="px-1.5 md:px-0">
                <SidebarMenu className="relative gap-1">
                  {devNavItems.map((item) => {
                    ...
                    const Icon = devNavIcons[item.url]
                    const link = (
                      <Link
                        to={item.url}
